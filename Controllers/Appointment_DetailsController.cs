...
namespace Doctor_Appointment_WebAPI_Xamarin_Backend.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class Appointment_DetailsController : ControllerBase
    {
        private readonly Doctor_Appointment_Database _context;

        public Appointment_DetailsController(Doctor_Appointment_Database context)
        {
            _context = context;
        }
